...
<p align="center">
  ...
  <div align="left">很简单的用 Rust 打包网页生成很小的 Mac App，底层使用 Tauri，支持微信读书、Flomo、RunCode、Whiteboard、ToolsFun、Vercel、即刻、RoamResearch 等，详细小白开发教程可见底部。</div>
</p>
...
<table>
    ...
    <tr>
        ...
        <td>Whiteboard <a href="https://github.com/tw93/Pake/releases/latest/download/Witeboard.dmg">Download</a></td>
    </tr>
    <tr>
