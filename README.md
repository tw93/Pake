...
2. **想折腾的**：使用 「命令行打包」，对 Mac 友好，Windows / Linux 需折腾下，均需 [环境配置](https://tauri.app/v1/guides/getting-started/prerequisites)。
3. **开发同学**：假如你前端和 Rust 都会，那可试试下面的 「定制开发」，可深度二次开发定制你的功能。
