...
const { green: green$1, yellow: yellow$1, blue, red } = chalk;
async function buildMobileApp(url, options, skipDesktopBuild = false) {
    ...
    for (const targetPlatform of platforms) {
        ...
        try {
            console.log(green$1(`📱 开始构建 ${targetPlatform.toUpperCase()} 应用...`));
            ...
            // 显示构建结果
            console.log(green$1(`✅ ${targetPlatform.toUpperCase()} 构建完成！`));
            ...
            if (fs.existsSync(outputDir)) {
                ...
                try {
                    ...
                    console.log(yellow$1('构建完成，请在输出目录中查找生成的文件'));
                }
            }
        }
        catch (error) {
    ...
    console.log(green$1('🎉 所有移动端平台构建完成！'));
