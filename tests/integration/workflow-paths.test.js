    ...
    it('should match Windows output paths', () => {
      ...
      const windowsPaths = {
        msi: {
          ...
          architectureSpecific: 'src-tauri/target/x86_64-pc-windows-msvc/release/bundle/msi',
    ...
    it('should match macOS output paths', () => {
      ...
      const macosPaths = {
        dmg: {
          ...
          universalBundle: 'src-tauri/target/universal-apple-darwin/release/bundle/dmg',
          // Regular builds
          genericBundle: 'src-tauri/target/release/bundle/dmg',
        },
        app: {
          primary: 'appname.app',
          universalBundle: 'src-tauri/target/universal-apple-darwin/release/bundle/macos',
